...
KMERFINER_CMD="$SCRIPTS_DIR/kmerfinder.sh $OUTPUT_DIR/kmerfinder $OUTPUT_DIR/kmerfinder $THREADS $SAMPLE_NAMES $KMERFINDER_PATH $BACT_DB_PATH $OUTPUT_CONCAT_NAMES $OUTPUT_KMERFINDER_NAMES "
