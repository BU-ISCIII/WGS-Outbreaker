...
#selectVariants
vcfsnpsArray_list=all_samples_snp.vcf
vcfindelsArray_list=all_samples_indels.vcf

#Variant filtration
vcfsnpsfilArray_list=all_samples_snp_fil.vcf
...
tsv_filsnp_file=snp_fil.tsv
msa_filsnp_file=snp_fil.fasta
...
dist_filsnp=distance_filsnp.txt
dist_passnp=distance_passnp.txt

dist_pair_filsnp=distance_pairs_filsnp.txt
dist_pair_passnp=distance_pairs_passnp.txt
